...
//====== EXTREME REACTORS BALANCE ======
	//====== Variables ======
	//
		var BRAngelsite = <bigreactors:oreanglesite>;
		var BRBentonite = <bigreactors:orebenitoite>;
	...
	//Blutonium Processing
		...
		recipes.addShapeless("crtBRblufix", BRBlutonium * 9, [<bigreactors:blockblutonium>]);
